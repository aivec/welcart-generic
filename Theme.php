...
class Theme
{
     ...
     *
     * @author Evan D Shaw <evandanielshaw@gmail.com>
     * @param array $deps array of dependencies for the `themes.css` file. Default: []
     * @return void
     */
    public static function enqueueThemeCss($deps = []) {
        $url = plugin_dir_url(__FILE__);
        wp_enqueue_style(self::VERSION . '-welcart-themes', $url . '/themes.css', $deps, self::VERSION);
    }
}
